    ...
    internal class Inventory
    {
        ...
        public static string ServiceCategoryLookup(string serviceName)
        {
            if (serviceName != "")
            {
                ...
                if (Settings.bDefaultManagedCategory == false && Settings.services_in_managed_category.Contains(serviceName))
                    return "Managed";
        ...
        public static bool InsertDefaultServiceDefinitions()
        {
            ...
            listWinServicesFromDefinition.Add(new WinServiceDefined("DHCPServer", "DHCP Server", "Role", "Automatic", "Running"));
            ...
            listWinServicesFromDefinition.Add(new WinServiceDefined("lpasvc", "Microsoft Policy Platform Local Authority", "Supporting", "Automatic", "Running"));
            listWinServicesFromDefinition.Add(new WinServiceDefined("lppsvc", "Microsoft Policy Platform Processor", "Supporting", "Automatic", "Running"));
            ...
            listWinServicesFromDefinition.Add(new WinServiceDefined("NetBackup SAN Client Fibre Transport Service", "NetBackup SAN Client Fibre Transport Service", "Managed", "Automatic", "Started"));
            ...
            listWinServicesFromDefinition.Add(new WinServiceDefined("ScvmmGuestServiceV5", "Microsoft System Center 2012 Virtual Machine Manager Guest Agent R2", "Managed", "Automatic", "Running"));
            ...
            listWinServicesFromDefinition.Add(new WinServiceDefined("clr_optimization_v2.0.50727_32", "Microsoft .NET Framework NGEN v2.0.50727_​X86", "Ignored", "Automatic", "Stopped"));
            listWinServicesFromDefinition.Add(new WinServiceDefined("clr_optimization_v2.0.50727_64", "Microsoft .NET Framework NGEN v2.0.50727_​X64", "Ignored", "Automatic", "Stopped"));
